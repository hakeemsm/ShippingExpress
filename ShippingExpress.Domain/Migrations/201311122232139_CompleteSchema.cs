namespace ShippingExpress.Domain.Migrations
{
    ...
    public partial class CompleteSchema : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ReceiverFirstName = c.String(nullable: false, maxLength: 50),
                        ReceiverLastName = c.String(nullable: false, maxLength: 50),
                        ...
                        ReceiverEmail = c.String(nullable: false, maxLength: 300),
                        CreatedOn = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Key)
